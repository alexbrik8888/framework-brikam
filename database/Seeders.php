...
class Seeders extends BaseController {
    ...
    public function createTableArticl() {
        $d = new DB();
        if (!$d->tableExists('articl')) {
            $d->statment("CREATE TABLE `articl` (
              `id` int(11) NOT NULL,
            ...
            echo "<p> Create tabel articl</p>";
        } else {
            echo "<p>  Tabel articl exists</p>";
        }
    }

    public function createTableUser() {
        $d = new DB();
        if(!$d->tableExists('user_admin')) {
            $d->statment("CREATE TABLE `user_admin` (
              `id` int(11) NOT NULL,
              `email` varchar(150) NOT NULL,
              `password` varchar(50) NOT NULL,
              `group` tinyint(4) NOT NULL DEFAULT 1
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
            echo  "<p> Create tabel user_admin</p>";
        }else {
            echo  "<p>  Tabel articl user_admin</p>";
        }
    }
    ...
    public function createTableCategory() {
        ...
        if(!$d->tableExists('category')) {
            $d->statment("CREATE TABLE `category` (
                      `id` int(11) NOT NULL,
            ...
            echo  "<p> Create tabel category</p>";
        }else {
            echo  "<p>  Tabel articl category</p>";
        }
    }
    public function createTableCategoryArticl() {
        $d = new DB();
        if(!$d->tableExists('category_articl')) {
            $d->statment("CREATE TABLE `category_articl` (
              `id` int(11) NOT NULL,
              `category_id` int(11) NOT NULL,
              `articl_id` int(11) NOT NULL
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
            echo  "<p> Create tabel category_articl</p>";
        }else {
            echo  "<p>  Tabel articl category_articl</p>";
        }
    }
    public function createTableFile() {
        $d = new DB();
        if(!$d->tableExists('file')) {
            $d->statment("CREATE TABLE `file` (
          `id` int(11) NOT NULL,
          ...
          `updated_at` timestamp NOT NULL
            ...
            echo  "<p> Create tabel file</p>";
        }else {
            echo  "<p>  Tabel articl file</p>";
        }
    }

    public function createTablearticlView() {
        $d = new DB();
        if(!$d->tableExists('articl_view')) {
        $d->statment("CREATE TABLE `articl_view` (
      `articl_id` int(11) NOT NULL,
      `view` int(11) NOT NULL DEFAULT 0
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
        echo  "<p> Create tabel articl_view</p>";
    }else {
            echo  "<p>  Tabel articl articl_view</p>";
        }
    ...
    public function insertCategoryArticl() {
        $category_articl = [
            ['id' => 1, 'category_id' => 1, 'articl_id' => 1],
            ['id' => 2, 'category_id' => 1, 'articl_id' => 2],
            ['id' => 3, 'category_id' => 1, 'articl_id' => 3],
            ['id' => 4, 'category_id' => 2, 'articl_id' => 4],
            ['id' => 5, 'category_id' => 2, 'articl_id' => 5],
            ['id' => 6, 'category_id' => 2, 'articl_id' => 6],
            ['id' => 7, 'category_id' => 3, 'articl_id' => 7],
            ['id' => 8, 'category_id' => 3, 'articl_id' => 8],
            ['id' => 9, 'category_id' => 3, 'articl_id' => 9],
            ['id' => 11, 'category_id' => 4, 'articl_id' => 11],
            ['id' => 12, 'category_id' => 4, 'articl_id' => 12],
            ['id' => 13, 'category_id' => 5, 'articl_id' => 13],
            ['id' => 14, 'category_id' => 5, 'articl_id' => 14],
            ['id' => 15, 'category_id' => 5, 'articl_id' => 15],
            ['id' => 16, 'category_id' => 6, 'articl_id' => 16],
            ['id' => 17, 'category_id' => 1, 'articl_id' => 16],
            ['id' => 18, 'category_id' => 6, 'articl_id' => 17],
            ['id' => 19, 'category_id' => 1, 'articl_id' => 17],
            ['id' => 20, 'category_id' => 6, 'articl_id' => 18],
            ['id' => 21, 'category_id' => 1, 'articl_id' => 18],
            ['id' => 22, 'category_id' => 7, 'articl_id' => 19],
            ['id' => 23, 'category_id' => 1, 'articl_id' => 19],
            ['id' => 24, 'category_id' => 7, 'articl_id' => 20],
            ['id' => 25, 'category_id' => 1, 'articl_id' => 20],
            ['id' => 26, 'category_id' => 7, 'articl_id' => 21],
            ['id' => 27, 'category_id' => 1, 'articl_id' => 21],
            ['id' => 28, 'category_id' => 8, 'articl_id' => 22],
            ['id' => 29, 'category_id' => 1, 'articl_id' => 22],
            ['id' => 30, 'category_id' => 8, 'articl_id' => 23],
            ['id' => 31, 'category_id' => 1, 'articl_id' => 23],
            ['id' => 32, 'category_id' => 8, 'articl_id' => 24],
            ['id' => 33, 'category_id' => 1, 'articl_id' => 24],
            ['id' => 34, 'category_id' => 9, 'articl_id' => 25],
            ['id' => 35, 'category_id' => 6, 'articl_id' => 25],
            ['id' => 36, 'category_id' => 1, 'articl_id' => 25],
            ['id' => 37, 'category_id' => 9, 'articl_id' => 26],
            ['id' => 38, 'category_id' => 6, 'articl_id' => 26],
            ['id' => 39, 'category_id' => 1, 'articl_id' => 26],
            ['id' => 40, 'category_id' => 9, 'articl_id' => 27],
            ['id' => 41, 'category_id' => 6, 'articl_id' => 27],
            ['id' => 42, 'category_id' => 1, 'articl_id' => 27],
            ['id' => 43, 'category_id' => 10, 'articl_id' => 28],
            ['id' => 44, 'category_id' => 6, 'articl_id' => 28],
            ['id' => 45, 'category_id' => 1, 'articl_id' => 28],
            ['id' => 46, 'category_id' => 10, 'articl_id' => 29],
            ['id' => 47, 'category_id' => 6, 'articl_id' => 29],
            ['id' => 48, 'category_id' => 1, 'articl_id' => 29],
            ['id' => 49, 'category_id' => 10, 'articl_id' => 30],
            ['id' => 50, 'category_id' => 6, 'articl_id' => 30],
            ['id' => 51, 'category_id' => 1, 'articl_id' => 30],
            ['id' => 52, 'category_id' => 11, 'articl_id' => 31],
            ['id' => 53, 'category_id' => 2, 'articl_id' => 31],
            ['id' => 54, 'category_id' => 11, 'articl_id' => 32],
            ['id' => 55, 'category_id' => 2, 'articl_id' => 32],
            ['id' => 56, 'category_id' => 11, 'articl_id' => 33],
            ['id' => 57, 'category_id' => 2, 'articl_id' => 33],
            ['id' => 58, 'category_id' => 12, 'articl_id' => 34],
            ['id' => 59, 'category_id' => 2, 'articl_id' => 34],
            ['id' => 60, 'category_id' => 12, 'articl_id' => 35],
            ['id' => 61, 'category_id' => 2, 'articl_id' => 35],
            ['id' => 62, 'category_id' => 12, 'articl_id' => 36],
            ['id' => 63, 'category_id' => 2, 'articl_id' => 36],
            ['id' => 64, 'category_id' => 13, 'articl_id' => 37],
            ['id' => 65, 'category_id' => 3, 'articl_id' => 37],
            ['id' => 66, 'category_id' => 13, 'articl_id' => 38],
            ['id' => 67, 'category_id' => 3, 'articl_id' => 38],
            ['id' => 68, 'category_id' => 13, 'articl_id' => 39],
            ['id' => 69, 'category_id' => 3, 'articl_id' => 39],
            ['id' => 70, 'category_id' => 14, 'articl_id' => 40],
            ['id' => 71, 'category_id' => 3, 'articl_id' => 40],
            ['id' => 72, 'category_id' => 14, 'articl_id' => 41],
            ['id' => 73, 'category_id' => 3, 'articl_id' => 41],
            ['id' => 74, 'category_id' => 14, 'articl_id' => 42],
            ['id' => 75, 'category_id' => 3, 'articl_id' => 42],
            ['id' => 76, 'category_id' => 2, 'articl_id' => 24],
            ['id' => 77, 'category_id' => 3, 'articl_id' => 34],
            ['id' => 78, 'category_id' => 6, 'articl_id' => 14],
            ['id' => 79, 'category_id' => 10, 'articl_id' => 41],
            ['id' => 80, 'category_id' => 4, 'articl_id' => 10],
            ];

        $d = new DB();
        if($d->tableExists('category_articl'))
            if($d->insertMultiple('category_articl',$category_articl ))
                echo  "<p>Error User admin Insert</p>";
    }

 public function insertUser (){
        $user = [['id'=>1,'email'=>'test@work.com','password'=>'827ccb0eea8a706c4c34a16891f84e7b','group'=>1]];
        $d = new DB();
     if($d->tableExists('user_admin'))
         if($d->insertMultiple('user_admin',$user ))
             echo  "<p>Error User admin Insert</p>";
 }
   ...
   public function insertCategory() {
       ...
       $d = new DB();
       if($d->tableExists('category'))
            if($d->insertMultiple('category',$categories ))
                echo  "<p>Error Category Insert</p>";
   }
   ...
   public function insertArticle() {
       $articles = [
        ...
        $d = new DB();
        if($d->tableExists('articl'))
            if(!$d->insertMultiple('articl',$articles))
                echo  "<p>Error Articl Insert</p>";
   }
